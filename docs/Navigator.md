...
* **Header picker** — `Ctrl-Alt-h` (PaperCutter). Every markdown [[Markdown/Basics|header]] in the space, ordered by page recency: the current page’s headers first. Headers of meta pages and pages hidden from navigation are left out.
